...
### **1. Project Overview**
Find a CFG with ∑ = {a,b} and will create the language L and contains strings which will have twice as many a's as there is b's. The grammar msut be proven correct and also must be justifiable why it is the simplest that could be made for this language L. 
